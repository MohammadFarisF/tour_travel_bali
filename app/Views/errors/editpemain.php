        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    ...
                    <div class="page-header-subtitle">Hai <?= session('username') ?> Selamat Datang Di Error Edit Pemain Chelsea FC #KTBFFH :)</div>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                            <div class="container-fluid px-4">
                                <div class="row g-3 my-4 text-center">
                                    ...
                                    <div class="col-12">
                                        <a class="text-arrow-icon" style="align-items: center;" href="<?= base_url() ?>/pemain">
                                            <i class="ms-0 me-1" data-feather="arrow-left"></i>
                                            Kembali Ke Read Pemain
                                        </a>
                                    </div>
                                </div>
                            </div>
